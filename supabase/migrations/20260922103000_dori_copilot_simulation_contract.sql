...
BEGIN
  ...
  result:=jsonb_build_object('id',eval_id,'test_case_id',c.test_case_id,'actual',actual,'match',matched,'classification',cls,'result_payload',p_result_payload); RETURN result;
END; $function$;
