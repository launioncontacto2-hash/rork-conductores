...
GRANT ALL ON public.dori_copilot_simulation_cases, public.dori_copilot_simulation_expectations, public.dori_copilot_simulation_evaluations TO postgres;
...
REVOKE ALL ON FUNCTION public.console_create_dori_simulation_case(uuid,text,text,uuid,jsonb,text,text,text,timestamptz), public.driver_get_dori_simulation_case(uuid,uuid), public.driver_next_dori_simulation_case(uuid), public.record_dori_simulation_evaluation(uuid,uuid,text,jsonb), public.driver_get_dori_simulation_evaluation(uuid,uuid,text) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.console_create_dori_simulation_case(uuid,text,text,uuid,jsonb,text,text,text,timestamptz), public.driver_get_dori_simulation_case(uuid,uuid), public.driver_next_dori_simulation_case(uuid), public.record_dori_simulation_evaluation(uuid,uuid,text,jsonb), public.driver_get_dori_simulation_evaluation(uuid,uuid,text) TO service_role;
