...
test("shows every final operational area from one Supabase snapshot", async () => {
  ...
  await expect.element(screen.getByRole("button", { name: /Versión 1.0.0 · Build 1003/ })).toBeInTheDocument();
...
test("opens the candidate release information without secrets", async () => {
  ...
  await screen.getByRole("button", { name: /Versión 1.0.0 · Build 1003/ }).click();
