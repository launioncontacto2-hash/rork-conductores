...
/// The financial RPC has nullable arguments that still belong to its PostgreSQL
/// signature. Omitting their JSON keys makes PostgREST search for a different overload.
