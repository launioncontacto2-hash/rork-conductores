/* Single source of decision logic, shared by backend and simulator; tested in Node.
...
(function (root) {
  ...
  /** @param {import('./dori-copilot.d.ts').TripCandidate} t */
  ...
  /** @param {import('./dori-copilot.d.ts').MarketContext} m */
  ...
  /** @param {import('./dori-copilot.d.ts').VehicleContext} v */
  ...
  /** @param {import('./dori-copilot.d.ts').DriverContext} d */
  ...
  /** @param {import('./dori-copilot.d.ts').DecisionInput} input
   * @param {import('./dori-copilot.d.ts').DecisionParameters=} supplied
   * @returns {import('./dori-copilot.d.ts').DecisionResult} */
  ...
  /** @returns {import('./dori-copilot.d.ts').DecisionEvent} */
  ...
  /** @returns {import('./dori-copilot.d.ts').OutcomeEvent} */
